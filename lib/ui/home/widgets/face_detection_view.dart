...
class FaceDetectionView extends StatelessWidget {
  ...
  Widget _buildImageButtons(BuildContext context, FaceDetectionProvider provider) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          CustomButton(
            ...
            label: 'Stock',
            onPressed: provider.pickStockImage, // You'll need to add this method to provider
          ),
        ],
      ),
    );
